...
public class VectorEx3 {
	...
	public static void main(String[] args) {
		Vector vlist = new Vector(4, 3);		// 저장공간 지정 (잘 사용하지 않음)
		...
		System.out.println(vlist.isEmpty());	// ~이나 아니냐
		System.out.println(vlist.remove(2));	//3번째 요소 삭제
		System.out.println(vlist.size());
		System.out.println(vlist.capacity());
		vlist.trimToSize(); //필요없는 용량 제거할때 사용
		System.out.println("----------------------------------------");
